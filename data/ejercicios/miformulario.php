...
<body>
    ...
    <form name="miformu" action="/autoriza.php" method="get">
        ...
        <p>
            ...
            <!--Name con ...[] para que pueda almacenar varios a la vez-->
        </p>

        <p>
            <p>Elige tu equipos de baloncesto preferido: </p>
            <label for="equipo1">Casedemont Zaragoza</label>
            <input type="radio" name="equipo" id="equipo1" value="Casademont Zaragoza">
